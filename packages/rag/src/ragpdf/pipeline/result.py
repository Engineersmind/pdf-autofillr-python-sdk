...
class FieldPrediction:
    ...
    matched: bool
    confidence: float
    field_name: str | None = None  # None if not matched
    vector_id: str | None = None
    vector_confidence: float | None = None  # stored confidence in that vector
    ...
    best_candidate: str | None = None  # top result even if below threshold
...
class PredictionResult:
    ...
    frequency: int
    is_duplicate: bool
    predictions: dict[str, FieldPrediction | None]  # field_id -> prediction or None
...
class ProcessingResult:
    ...
    submission_id: str
    success: bool
    case_classification: dict | None = None
    metrics: dict | None = None
    vector_update_summary: dict | None = None
    error: str | None = None
...
class FeedbackResult:
    ...
    updated_accuracy: dict | None = None
    error: str | None = None
