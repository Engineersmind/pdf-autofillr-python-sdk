...
class GCSStorage(StorageBackend):
    def __init__(self, bucket: str = "", prefix: str = ""):
        try:
            ...
            raise ImportError("GCSStorage requires google-cloud-storage. Install with: pip install ragpdf-sdk[gcs]")
        ...
        logger.info(f"GCSStorage initialized: bucket={self._bucket_name}, prefix={self._prefix}")
    ...
    def append_to_jsonl(self, key: str, data: dict) -> None:
        ...
        try:
            ...
            pass
        blob = self._bucket.blob(self._blob_name(key))
        blob.upload_from_string(existing + json.dumps(data) + "\n", content_type="application/jsonl")
