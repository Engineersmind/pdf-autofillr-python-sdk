...
def _copy_module_source(dest: str = "./ragpdf"):
    ...
    print(f"  Add this to your .env:  RAGPDF_MODULE_PATH=./ragpdf\n")
...
def _create_ragpdf_data(base: str = "./data/rag", force: bool = False):
    ...
    vec_defs = [
        ("vec_001", "investor_full_legal_name",   "Full legal name of the investor as it appears on government-issued ID",         "Investor Identity",       ["Section 1", "Personal Information"], 1,  14, 0, 18, 1.0,    [0.75, 0.7875, 0.8268, 0.8682, 0.9116],         "rag"),
        ("vec_002", "investor_email_address",     "Email address for all fund correspondence and notices",                         "Contact Details",         ["Section 2", "Contact"],              2,  8,  0, 10, 1.0,    [0.75, 0.7875, 0.8268],                         "rag"),
        ("vec_003", "tax_identification_number",  "Social Security Number or Employer Identification Number for tax reporting",    "Tax Information",         ["Section 3", "Tax Details"],          3,  4,  2, 9,  0.6667, [0.75, 0.7125, 0.6769],                         "rag"),
        ("vec_004", "commitment_amount_usd",      "Total capital commitment amount in US dollars",                                 "Investment Details",      ["Section 4", "Subscription Amount"],  4,  10, 0, 12, 1.0,    [0.75, 0.7875, 0.8268, 0.8682],                 "rag"),
        ("vec_005", "investor_type",              "Type of investor entity - individual, trust, corporation, partnership",         "Investor Classification", ["Section 1", "Entity Type"],          5,  18, 0, 22, 1.0,    [0.75, 0.7875, 0.8268, 0.8682, 0.9116, 0.9572], "rag"),
        ("vec_006", "residential_address_line1",  "Street address line 1 of principal place of residence or business",            "Address",                 ["Section 2", "Address Details"],      6,  7,  0, 9,  1.0,    [0.75, 0.7875, 0.8268],                         "llm"),
        ("vec_007", "date_of_birth",              "Date of birth of the individual investor",                                     "Personal Information",    ["Section 1", "KYC Details"],          7,  5,  1, 8,  0.8333, [0.75, 0.7875],                                  "rag"),
        ("vec_008", "accredited_investor_status", "Confirmation of accredited investor status under SEC Rule 501",                 "Investor Qualification",  ["Section 5", "Accreditation"],        8,  12, 0, 14, 1.0,    [0.75, 0.7875, 0.8268, 0.8682, 0.9116],         "rag"),
        ("vec_009", "bank_account_number",        "Bank account number for capital call wire transfers",                          "Banking Details",         ["Section 6", "Wire Instructions"],    9,  6,  0, 8,  1.0,    [0.75, 0.7875, 0.8268],                         "llm"),
        ("vec_010", "signature_date",             "Date on which the subscription agreement is signed by the investor",           "Execution",               ["Signature Page"],                    10, 9,  0, 11, 1.0,    [0.75, 0.7875, 0.8268, 0.8682],                 "rag"),
        ("vec_011", "country_of_citizenship",     "Country of citizenship or incorporation for FATCA/CRS compliance",             "Regulatory Compliance",   ["Section 7", "FATCA / CRS"],          11, 8,  0, 10, 1.0,    [0.75, 0.7875, 0.8268, 0.8682],                 "rag"),
        ("vec_012", "beneficial_owner_name",      "Name of the ultimate beneficial owner of the investing entity",                "AML / KYC",               ["Section 8", "AML Compliance"],       12, 5,  0, 7,  1.0,    [0.75, 0.7875, 0.8268],                         "llm"),
    ]
    vectors = []
    for vid, fname, ctx, sctx, hdrs, seed, pos, neg, usage, stab, hist, src in vec_defs:
        vectors.append({
            "vector_id": vid, "field_name": fname,
            "context": ctx, "section_context": sctx, "headers": hdrs,
            "embedding": make_emb(seed),
            "confidence_history": hist,
            "positive_count": pos, "negative_count": neg,
            "usage_count": usage, "stability_score": stab,
            "avg_confidence": round(sum(hist) / len(hist), 4),
            "error_history": [
                {"timestamp": "2026-02-14T10:00:00Z", "pdf_hash": "ddeeff445566",
                 "error_type": "wrong_field_name", "user_feedback": "Corrected by user",
                 "corrected_to": "ssn_or_ein", "original_confidence": 0.75}
            ] if neg > 0 else [],
    ...
    _write_json(f"{base}/vectors/vector_database.json", {
        "metadata": {"total_count": len(vectors), "last_updated": "2026-03-15T09:11:00Z"},
        "vectors": vectors
    }, force)
    ...
    _write_json(f"{base}/pdf_hash_mapping/mapping.json", {
        ...
        "ddeeff445566": {
            "pdf_hash": "ddeeff445566", "pdf_id": "pdf_002",
            "category": "Private Markets", "sub_category": "Private Credit",
            "document_type": "Side Letter Agreement",
            "pdf_count": 1, "total_submissions": 1,
            "submissions": [
                {"submission_id": "user_03_session_02_pdf_002_1_1737964800",
                 "user_id": "user_03", "session_id": "session_02", "pdf_id": "pdf_002",
                 "frequency": 1, "timestamp": "2026-01-27T10:00:00Z", "total_fields": 8,
                 "accuracy_llm": 0.875, "accuracy_rag": 0.75, "accuracy_ensemble": 0.875, "errors_reported": 1},
            ],
            "aggregated_stats": {
                "avg_accuracy_llm": 0.875, "avg_accuracy_rag": 0.75, "avg_accuracy_ensemble": 0.875,
                "avg_coverage_llm": 0.875, "avg_coverage_rag": 0.75,
                "total_errors": 1, "consistency_score": 0.8125, "improvement_trend": "new"
            },
            "first_seen": "2026-01-27T10:00:00Z", "last_seen": "2026-01-27T10:00:00Z"
        }
    }, force)
    ...
    _write_json(f"{base}/metrics/time_series/global/time_series.json", {
        ...
        "entries": [
            {"timestamp": "2026-01-10T08:00:00Z",
             "submission_id": "user_01_session_01_pdf_001_1_1736496000",
             "user_id": "user_01", "session_id": "session_01", "pdf_id": "pdf_001",
             "metrics": {"total_fields": 12, "predicted_llm": 11, "predicted_rag": 10, "predicted_ensemble": 11,
                         "coverage_llm": 0.9167, "coverage_rag": 0.8333, "coverage_ensemble": 0.9167,
                         "accuracy_llm": 1.0, "accuracy_rag": 1.0, "accuracy_ensemble": 1.0,
                         "avg_conf_llm": 0.891, "avg_conf_rag": 0.876, "avg_conf_ensemble": 0.884,
                         "agreement_rate": 0.909, "conflict_rate": 0.091,
                         "rag_recovery": 0.0, "llm_recovery": 0.1,
                         "errors_llm": 0, "errors_rag": 0, "errors_ensemble": 0}},
            {"timestamp": "2026-01-27T10:00:00Z",
             "submission_id": "user_03_session_02_pdf_002_1_1737964800",
             "user_id": "user_03", "session_id": "session_02", "pdf_id": "pdf_002",
             "metrics": {"total_fields": 8, "predicted_llm": 7, "predicted_rag": 6, "predicted_ensemble": 7,
                         "coverage_llm": 0.875, "coverage_rag": 0.75, "coverage_ensemble": 0.875,
                         "accuracy_llm": 0.875, "accuracy_rag": 0.75, "accuracy_ensemble": 0.875,
                         "avg_conf_llm": 0.862, "avg_conf_rag": 0.841, "avg_conf_ensemble": 0.854,
                         "agreement_rate": 0.857, "conflict_rate": 0.143,
                         "rag_recovery": 0.0, "llm_recovery": 0.125,
                         "errors_llm": 1, "errors_rag": 2, "errors_ensemble": 1}},
            {"timestamp": "2026-02-04T12:00:00Z",
             "submission_id": "user_02_session_03_pdf_001_2_1738694400",
             "user_id": "user_02", "session_id": "session_03", "pdf_id": "pdf_001",
             "metrics": {"total_fields": 12, "predicted_llm": 11, "predicted_rag": 11, "predicted_ensemble": 11,
                         "coverage_llm": 0.9167, "coverage_rag": 0.9167, "coverage_ensemble": 0.9167,
                         "accuracy_llm": 0.9167, "accuracy_rag": 0.9167, "accuracy_ensemble": 0.9167,
                         "avg_conf_llm": 0.903, "avg_conf_rag": 0.897, "avg_conf_ensemble": 0.9,
                         "agreement_rate": 1.0, "conflict_rate": 0.0,
                         "rag_recovery": 0.0, "llm_recovery": 0.0,
                         "errors_llm": 1, "errors_rag": 1, "errors_ensemble": 1}},
            {"timestamp": "2026-03-05T09:00:00Z",
             "submission_id": "user_01_session_05_pdf_001_3_1741132800",
             "user_id": "user_01", "session_id": "session_05", "pdf_id": "pdf_001",
             "metrics": {"total_fields": 12, "predicted_llm": 12, "predicted_rag": 12, "predicted_ensemble": 12,
                         "coverage_llm": 1.0, "coverage_rag": 1.0, "coverage_ensemble": 1.0,
                         "accuracy_llm": 1.0, "accuracy_rag": 1.0, "accuracy_ensemble": 1.0,
                         "avg_conf_llm": 0.924, "avg_conf_rag": 0.918, "avg_conf_ensemble": 0.921,
                         "agreement_rate": 1.0, "conflict_rate": 0.0,
                         "rag_recovery": 0.0, "llm_recovery": 0.0,
                         "errors_llm": 0, "errors_rag": 0, "errors_ensemble": 0}},
        ],
        "metadata": {"total_entries": 4,
...
def main():
    ...
    parser.add_argument("--path",  default="./data/rag", help="Data folder path (default: ./data/rag)")
    parser.add_argument("--force", action="store_true",     help="Overwrite existing files")
    parser.add_argument("--edit",  action="store_true",     help="Skip prompt, always copy module source")
    parser.add_argument("--no-edit", action="store_true",   help="Skip prompt, never copy module source")
