...
RAGPDF_LITELLM_EMBEDDING_MODEL = os.getenv("RAGPDF_LITELLM_EMBEDDING_MODEL", "openai/text-embedding-3-small")
...
RAGPDF_LITELLM_CORRECTOR_MODEL    = os.getenv("RAGPDF_LITELLM_CORRECTOR_MODEL",    "openai/gpt-4o-mini")
RAGPDF_LITELLM_CORRECTOR_TEMP     = float(os.getenv("RAGPDF_LITELLM_CORRECTOR_TEMP",  "0.3"))
RAGPDF_LITELLM_CORRECTOR_TOKENS   = int(os.getenv("RAGPDF_LITELLM_CORRECTOR_TOKENS",  "500"))
