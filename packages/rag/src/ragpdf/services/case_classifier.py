...
class CaseClassifier:
    ...
    def classify(
        ...
        session_id: str,
        pdf_id: str,
        rag_predictions: dict,
        llm_predictions: dict,
        final_predictions: dict,
    ) -> dict:

        case_breakdown: dict[str, Any] = {
            CASE_A: {
                "count": 0,
                "field_ids": [],
                "description": "Both RAG and LLM predicted same field",
            },
            CASE_B: {
                "count": 0,
                "field_ids": [],
                "description": "Both predicted different fields",
                "selections": {"rag_selected": 0, "llm_selected": 0},
            },
            CASE_C: {
                "count": 0,
                "field_ids": [],
                "description": "LLM predicted, RAG did not",
            },
            CASE_D: {
                "count": 0,
                "field_ids": [],
                "description": "RAG predicted, LLM did not",
            },
            CASE_E: {
                "count": 0,
                "field_ids": [],
                "description": "Neither predicted (below threshold)",
            },
        }
