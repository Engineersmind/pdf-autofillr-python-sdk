    ...
    def update_all_time_series(
        ...
        levels = [
            (
                "pdf_hash",
                pdf_hash,
                f"metrics/time_series/pdf_hash/{pdf_hash}/time_series.json",
            ),
            (
                "category",
                category,
                f"metrics/time_series/category/{category}/time_series.json",
            ),
            (
                "subcategory",
                f"{category}/{subcategory}",
                f"metrics/time_series/subcategory/{category}/{subcategory}/time_series.json",
            ),
            (
                "doctype",
                f"{category}/{subcategory}/{doctype}",
                f"metrics/time_series/doctype/{category}/{subcategory}/{doctype}/time_series.json",
            ),
