...
_ALL_DOC_UPLOAD_VARS = [
    "DOC_UPLOAD_LLM_MODEL", "DOC_UPLOAD_LLM_API_KEY", "DOC_UPLOAD_STORAGE",
    "DOC_UPLOAD_DATA_PATH", "DOC_UPLOAD_CONFIG_PATH", "DOC_UPLOAD_PDF_FILLER",
    "DOC_UPLOAD_PDF_PATH", "DOC_UPLOAD_TELEMETRY", "DOC_UPLOAD_LOG_LEVEL",
    "DOC_UPLOAD_DEBUG_LOGGING", "DOC_UPLOAD_LLM_TEMPERATURE",
    "DOC_UPLOAD_LLM_MAX_TOKENS", "DOC_UPLOAD_LLM_TIMEOUT",
    "DOC_UPLOAD_LLM_MAX_RETRIES", "DOC_UPLOAD_PDF_POLL_INTERVAL",
    "DOC_UPLOAD_PDF_POLL_TIMEOUT", "DOC_UPLOAD_PDF_MAX_RETRIES",
    "MAPPER_API_URL", "MAPPER_API_KEY",
]
...
class TestDocUploadSettings:
    ...
    def test_env_override(self, monkeypatch):
        from pdf_autofillr_doc_upload.config.settings import DocUploadSettings
        monkeypatch.setenv("DOC_UPLOAD_LLM_MODEL", "anthropic/claude-3-5-haiku-20241022")
