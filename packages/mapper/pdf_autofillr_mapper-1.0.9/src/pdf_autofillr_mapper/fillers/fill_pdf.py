...
async def fill_with_java(
    ...
    possible_jar_paths = [
        ...
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "java_utils", "form_field_filler", "target", "form_field_filler-1.0.0-jar-with-dependencies.jar"),  # Bundled in wheel
