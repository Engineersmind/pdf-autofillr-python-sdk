# modules3/mapper/src/pdf_autofillr_mapper/orchestrator.py
...
class PDFPipeline:
    ...
    def __init__(
        ...
        if mapper_config is not None:
            ...
            self.config.setdefault("confidence_threshold", mapper_config.confidence_threshold)
            self.config.setdefault("chunking_strategy", mapper_config.chunking_strategy)
            self.config.setdefault("include_description", mapper_config.include_description)
