...
async def run_embed_java_stage(
    ...
    possible_jar_paths = [
        ...
        os.path.join(os.path.dirname(os.path.dirname(__file__)), "java_utils", "form_field_rebuilder", "target", "form_field_rebuilder-1.0.0-jar-with-dependencies.jar"),  # Bundled in wheel
