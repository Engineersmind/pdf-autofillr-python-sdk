class BoundingBox:
    ...
    def __init__(self, left, t, r=None, b=None, width=None, height=None, rounding=1):
        self.rounding = rounding  # Set rounding precision
        self.left = round(left, rounding)
        ...
        if r is not None and b is not None:
            ...
            self.width = round(r - left, rounding)
            ...
            self.r = round(left + width, rounding)
    ...
    def to_dict(self):
        ...
        return {
            "left": round(self.left, self.rounding),
    ...
    def __repr__(self):
        return (
            f"BoundingBox(l={self.left}, t={self.t}, r={self.r}, b={self.b}, "
